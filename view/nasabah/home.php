...
<head>
  ...
  <title>BTN Syariah | Nasabah</title>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          $info=mysqli_query($conn,"select pengajuan.id, akun.nama, pengajuan.no_ktp, pengajuan.developer, pengajuan.status, pengajuan.keterangan from pengajuan, akun where pengajuan.username = akun.username and akun.username='".$_SESSION['username']."'"); 
        ...
        <div class="container-fluid">
          <div class="form-group row">
            ...
            <div class="col-lg-8">
              <input type="text" class="form-control" name="id" value="<?php echo $irow['id']; ?>" readonly>
              </div>
            </div>
          <div class="form-group row">
            <div class="col-lg-4">
            ...
            <div class="form-group row">
              <table class="table table-bordered">
                ...
                <tbody>
                <?php
                    $kquery=mysqli_query($conn,"select status, tanggal from status where username='".$_SESSION['username']."'");
      ...
      ?>
        ...
        <?php } 
            ...
            echo "Nasabah Belum Mengajukan Aplikasi";
          }
        ?>
        </div>
        <!-- /.card-body -->
